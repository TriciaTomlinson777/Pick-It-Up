      ...
      <main className="bg-[#fdf7e8] text-[#002244]">
        ...
        <section className="border-y border-[#0f9aa1]/45 bg-[linear-gradient(122deg,_#1aa1ab_0%,_#58c92e_50%,_#f0ab2f_100%)] py-14 text-[#002244] sm:py-16">
          <div className="container-custom text-center">
            ...
            <div className="homepage-featured-gallery-row mx-auto mt-10 grid w-full gap-6 text-left xl:grid-cols-2 xl:items-stretch xl:gap-8">
              <Link
                href="/thank-yous"
                className="homepage-featured-gallery-card group relative flex h-full rounded-[1.5rem] border border-[#0f9aa1]/45 bg-white p-1.5 text-[#fffef8] shadow-[0_12px_24px_rgba(0,43,73,0.11)] transition duration-200 hover:-translate-y-1 hover:shadow-[0_18px_30px_rgba(0,43,73,0.15)] focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-[#0f9aa1]/24"
              >
                <div className="relative flex h-full min-h-[18rem] flex-col overflow-hidden rounded-[1.2rem] border border-white/80 xl:min-h-[20rem]">
                  ...
                  <div className="relative z-20 ml-auto w-full max-w-none rounded-xl border border-white/45 bg-white/24 px-3 py-2 text-xs font-medium leading-relaxed text-[#002b49] sm:text-[13px] xl:absolute xl:right-4 xl:top-4 xl:w-auto xl:max-w-[17.5rem]">
                  ...
                  <div className="relative z-10 mt-auto flex flex-col justify-end p-5 sm:p-6">
