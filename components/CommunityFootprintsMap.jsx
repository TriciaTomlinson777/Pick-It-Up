    ...
    <>
      ...
      <style jsx global>{`
        ...
        .map-stage.is-focused {
          animation: mapStageFocusSequence 4.8s ease-in-out 1;
        }
        ...
        .cleanup-footprint-marker.is-dropping .cleanup-footprint-pin {
          animation: footprintDrop 1s cubic-bezier(0.18, 0.84, 0.24, 1) 1;
        }

        .cleanup-footprint-ripple {
          animation: footprintRipple 1.8s ease-out 1;
          transform-origin: center;
        }

        @keyframes mapStageFocusSequence {
          0% {
            transform: scale(1);
          }
        ...
        @keyframes footprintDrop {
          0% {
            transform: translateY(-34px) scale(1.5);
            opacity: 0;
          }
